export class Vector3 {
  ...
  static rotateY(vector: number[], angle_rad: number) {
...
export class Quaternion {
  static normalize(quaternion: number[]) {
  ...
  static multiply(quaternion_a: number[], quaternion_b: number[]) {
  ...
  static rotateAxis(quaternion: number[], axis: number[], angle_rad: number) {
  ...
  static rotateX(quaternion: number[], angle_rad: number) {
    const angle_half = angle_rad / 2;
  ...
  static rotateY(quaternion: number[], angle_rad: number) {
    const angle_half = angle_rad / 2;
  ...
  static rotateZ(quaternion: number[], angle_rad: number) {
    const angle_half = angle_rad / 2;
  ...
  static toEuler(quaternion: number[]) {
...
export class Matrix4 {
  ...
  static translation(translation_vector: number[]) {
    return [
      1,
      0,
      0,
  ...
  static rotationX(angle_rad: number) {
    const angle_sin = Math.sin(angle_rad);
    const angle_cos = Math.cos(angle_rad);
  ...
  static rotationY(angle_rad: number) {
    const angle_sin = Math.sin(angle_rad);
    const angle_cos = Math.cos(angle_rad);
  ...
  static rotationZ(angle_rad: number) {
    const angle_sin = Math.sin(angle_rad);
    const angle_cos = Math.cos(angle_rad);
  ...
  static rotationFromQuaternion(quaternion: number[]) {
  ...
  static scaling(scale_vector: number[]) {
    return [
      scale_vector[0],
      0,
      0,
  ...
  static multiplay(matrix_a: Matrix4, matrix_b: Matrix4) {
